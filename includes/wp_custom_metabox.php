...
class customCMB2Class
{
    ...
    public function __construct()
    {
        ...
        add_action('cmb2_admin_init', array($this, 'rctv_register_custom_metabox'));
    }

    /**
     * Register custom metaboxes.
     */
    public function rctv_register_custom_metabox()
    {
        $prefix = 'rctv_';

        $cmb_metabox = new_cmb2_box(array(
            'id'            => $prefix . 'metabox',
            'title'         => esc_html__('Test Metabox', 'rctv'),
        ...
        $cmb_metabox->add_field(array(
            'name'       => esc_html__('Test Text', 'rctv'),
            'desc'       => esc_html__('field description (optional)', 'rctv'),
            'id'         => $prefix . 'text',
            'type'       => 'text',
